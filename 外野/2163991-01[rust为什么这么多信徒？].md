...
<strong>image.png</strong> (368.84 KB, 下载次数: 1)
...
##### 138#       发表于 2024-3-1 09:05
 ...
 本帖最后由 a4ac7 于 2024-3-1 09:10 编辑 

不支持空安全特性的语言我觉得不太安全🐶

java-&gt;kotlin,js-&gt;ts,其他不太了解
...
但源代码转LLVM IR自然是极其成熟的，但LLVM转回源码也就emscripten这样的有人用所以比较成熟，反编译器转成C的都没需要求，效果自然差,retdec作者都把ir2c那玩意删除出项目了

更何况转成源码跑通还好，但是需要人看的就难了

从汇编到llvm IR，大模型是有用的，Facebook前几个月开源了一个模型。不过能不能用就另说了，反正测试了复杂点的都不行，IR都如此，更别说选哪种转换了
