...
游戏片头 document.getElementById('flv_UsE').innerHTML=("");
...
   document.getElementById('flv_VG0').innerHTML=("");
...
忍具看着多,几个大刀和枪类飞镖基本都是一样的作用.还是原本的近战范围和直线射击.
