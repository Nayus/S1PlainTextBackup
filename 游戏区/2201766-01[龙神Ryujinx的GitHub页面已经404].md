...
|----|---|---|
| 江戸前ルナ| + 2|好评加鹅|
| 江南映月| + 2|支持，反对任天堂这个版权恶魔.|
| xioe|-2|盗版狗总是会找理由|
| moeblack|-1|我真玩任天堂的游戏|
| DJYDJYD| + 2|不至于|
| rizutoaoitori| + 1||
| unlsycn| + 2||
| emiya001|-2|思路广|
...
| posthoc|-2|“法律层面”|
| unlsycn|-2|那这是走法律渠道吗|
| Redimercia| + 1|怎么还有闸种有B脸扣鹅的整笑了.|
| 佩露夏| + 1|好评加鹅|
| Veygo| + 1||
| Patlain| + 2||
| RiesbyfeAtlasia| + 2||
| thrust|-1|法律跟道德不是从来两回事？|
| Hydrogen_L| + 1||
| TANA| + 1||
| 相参降解社畜|-2||
| wowheyyy| + 1|唉 任地狱的大手|
...
##### 43#         楼主| 发表于 2024-10-2 14:53
 ...
 本帖最后由 Xerxes_2 于 2024-10-3 19:48 编辑 
...
ryujinx的技术路线可太有趣了，一开始是把arm指令翻译成CLR IL跑在.net运行时上的。因为.net的JIT编译器叫RyuJIT，而ns的开发代号叫nx，所以才合起来取名Ryujinx。而且神奇的是隔了一层运行时，还能获得和原生C++的yuzu相仿的性能。

作为一个纯C#/.NET项目，技术架构非常优雅，开发环境配置简便编译简单。我是第一次见识到用传统认识上比较重的语言/运行时还能写出高性能的模拟器。
...
|昵称|战斗力|理由|
|----|---|---|
| BotRondo| + 2|任天堂赚的钱又不会到你们兜里.|
| 寇马可| + 1|任豚团建笑死|
| unlsycn| + 2|好评加鹅|
| UNICORN00| + 1|好评加鹅|
| aritionkb| + 1||
| 业余装备魔法师| + 1|好评加鹅|
| RiesbyfeAtlasia|-2|太惋惜了|
| Gundamslave| + 1||
| 你知道我的| + 2||
| 浅色轮回| + 2|好评加鹅|
| 昆仑之巅|-1|**立牌坊还有太监舔狗叫好，滑天下之大稽。.|
| shudushimo| + 1|慷谁的慨了？|
| 隔夜的哈劳斯| + 1||
| banrendacha|-1|互联网精神不该是慷他人之慨|
...
##### 46#       发表于 2024-10-2 15:38
 ...
 本帖最后由 obiy 于 2024-10-2 17:23 编辑 
<blockquote><a href="httphttps://bbs.saraba1st.com/2b/forum.php?mod=redirect&amp;goto=findpost&amp;pid=66361444&amp;ptid=2201766" target="_blank">伊迪潘宫森 发表于 2024-10-2 14:42</a>
想玩你随时可以玩啊，指个路fitgirlrepack直接给你打包了开封既玩，都不用你搞固件和key，甚至可以用磁力下 ...</blockquote>
私下联系开发者是怎么得出从法律层面上维权的

断人财路当然就不是无缘无故了，法律上没把柄这不还有专利嘛<img src="https://static.saraba1st.com/image/smiley/face2017/037.png">

没影响论坛玩家玩游戏，也不妨碍论坛玩家批判一个国家的产业政策不是吗
...
乔布斯当年也只说微软没有品味，可没说微软没有技术<img src="https://static.saraba1st.com/image/smiley/face2017/067.png">
...
每次模拟器被弄的帖子下都有人不知道是装傻还是真傻“都怪你任不发新机/4399画质别人才去玩模拟器”，当真对模拟器(尤其是本世代机子模拟器)用户画像没点b数了？<img src="https://static.saraba1st.com/image/smiley/face2017/049.png">电子海盗也要立自己的赛博牌坊？
...
<img src="https://static.saraba1st.com/image/smiley/face2017/067.png">说得好像大多数反对的也是技术爱好者一样
...
##### 64#         楼主| 发表于 2024-10-2 19:10
 ...
 本帖最后由 Xerxes_2 于 2024-10-2 19:12 编辑 
...
<img src="https://pbs.twimg.com/media/GW8mWnTXwAAAJQM?format=jpg&amp;name=large" height="450" id="aimg_UDGmz" onclick="zoom(this)" onmouseover="img_onmouseoverfunc(this)" style="cursor:pointer" width="800"/)

<img src="https://pbs.twimg.com/media/GW8mY6DWoAEOB_w?format=jpg&amp;name=large" height="433" id="aimg_IleA1" onclick="zoom(this)" onmouseover="img_onmouseoverfunc(this)" style="cursor:pointer" width="800"/)

<img src="https://pbs.twimg.com/media/GW8meT5W8AAZCod?format=jpg&amp;name=large" height="434" id="aimg_HgCc4" onclick="zoom(this)" onmouseover="img_onmouseoverfunc(this)" style="cursor:pointer" width="800"/)

<img src="https://pbs.twimg.com/media/GW8mkZIWoAEy53u?format=jpg&amp;name=large" height="450" id="aimg_Fn7Z1" onclick="zoom(this)" onmouseover="img_onmouseoverfunc(this)" style="cursor:pointer" width="800"/)

比较重要的大作，比如FH2和FH3，目前只能到打开标题画面和目录的地步

<img src="https://pbs.twimg.com/media/GXDAzurWkAAu0x4?format=jpg&amp;name=large" height="503" id="aimg_KgKNH" onclick="zoom(this)" onmouseover="img_onmouseoverfunc(this)" style="cursor:pointer" width="800"/)

<img src="https://pbs.twimg.com/media/GXDKBihXIAAU_oF?format=jpg&amp;name=large" height="499" id="aimg_O00z4" onclick="zoom(this)" onmouseover="img_onmouseoverfunc(this)" style="cursor:pointer" width="800"/)
...
##### 78#       发表于 2024-10-2 22:16
 ...
 本帖最后由 VVhaleVoice 于 2024-10-3 00:25 编辑 

这个糟糕信号，为啥在NS半退休的这个阶段出手，

虽然古川说过今后会继续提供NS平台游戏，但我们不知道具体力度有多大

仿佛这就是在说，未来NS1、2的跨平台时间段还会很大
...
##### 80#       发表于 2024-10-2 23:01
 ...
 本帖最后由 obiy 于 2024-10-2 23:18 编辑 
...
因为论坛里没几个万南粉丝<img src="https://static.saraba1st.com/image/smiley/face2017/067.png" referrerpolicy="no-referrer">

<img src="https://p.sda1.dev/19/e78026e7a23e0d25d7103b7a3b1bc103/image.jpg" referrerpolicy="no-referrer">
...
##### 96#       发表于 2024-10-3 17:31
 ...
 本帖最后由 nozomitech 于 2024-10-3 10:41 编辑 

我想问一下担心没有盗版就会导致当任天堂下架现有的Eshop服务器很多游戏就再也玩不到了，这点我可以理解。那为什么现在没有人对越来越多厂商开始弄手游或者线上服务型游戏这点有所表示呢？单机游戏的商店再怎么样也能坚持15-20年的时间（3ds和psv比较短命，只有12年），ns这代往后的游戏至少足够我们论坛这一代人的游玩需求了，很多手游或者服务型游戏几年就关服，别说游戏本身连游戏用的美术素材都永久丢失怎么从来没有人因为这点出来抵制呢？或者至少要求厂商给那些嗑过金的玩家一个合理的解决方案呢？我很奇怪，这是不是某种意义上有点双标？或者，或者说只是某些人想正大光明搞破解的一个“伟大”的借口？
...
##### 104#       发表于 2024-10-3 19:17
 ...
 本帖最后由 pico少年 于 2024-10-3 19:22 编辑 
<blockquote><a href="httphttps://bbs.saraba1st.com/2b/forum.php?mod=redirect&amp;goto=findpost&amp;pid=66368207&amp;ptid=2201766" target="_blank">NameLess2501 发表于 2024-10-3 18:01</a>

扫书公开分享，Z Library上传论文，和制作游戏镜像公开，有区别吗？

— from S1 Next Goose v3.2.91 ...</blockquote>
没区别呀，我就不信这帖子里指责玩盗版，模拟器就是盗版，盗版搞死的没碰过盗版\模拟器，一群头上长屁股，用屁股说话的伪君子。
...
##### 126#       发表于 2024-10-4 01:35
 ...
 本帖最后由 nozomitech 于 2024-10-3 18:37 编辑 
...
我的观点很简单，玩盗版没什么，我们的生活盗版无处不在，就像我楼上说的，台式机很多人装的系统是盗版的，e站上看的本子是盗版的，115上下的正经不正经的片子是盗版的，你学习使用的各种工业/生产力软件多半也是盗版的，但如果有些人编这么些冠冕堂皇的理由说什么为了永久保存游戏备份，然后把搞破解弄成什么很正义的行为那大可不必，你可以说这是盗版客观上顺便带来的好处，并且是非常积极意义上的好处，但这并不是盗版本来的核心目标。
...
##### 172#       发表于 2024-10-4 11:20
 ...
 本帖最后由 hanan1 于 2024-10-4 11:25 编辑 

受装机量，地区，游戏本身，时代所严重影响的数据也能当成证据

好像豚豚就没人对更好的画面，更高的帧数有需求一样，不敢开就不敢开，缩就完事了
...
##### 182#       发表于 2024-10-4 11:57
 ...
 本帖最后由 hanan1 于 2024-10-4 12:02 编辑 
...
##### 201#       发表于 2024-10-4 13:05
 ...
 本帖最后由 gane1010 于 2024-10-4 13:12 编辑 

个人是正版盗版混着玩的  现役的机器玩正版  以前的psp 3ds现在玩模拟器 这么多年 早年间机器也老化了 一些实机还没模拟玩的舒服  个人是支持模拟器的 不过最好是主机末期发布  你在主机前中期就发布 而且还跳脸官方就过分了   自己偷偷玩就行了   玩盗版这事在道义和法律上也是说不过的事
...
##### 203#       发表于 2024-10-4 13:09
 ...
 本帖最后由 病態極端 于 2024-10-4 13:18 编辑 
<blockquote><a href="httphttps://bbs.saraba1st.com/2b/forum.php?mod=redirect&amp;goto=findpost&amp;pid=66372915&amp;ptid=2201766" target="_blank">gg326 发表于 2024-10-4 12:48</a>

虽然没人能证明盗版对正版销量有多大影响，但这年头PC上是个商业游戏都上D加密来看，厂商认为花十几几十万 ...</blockquote>
D加密問世10年，目前一共只有255款D加密遊戲。
...
##### 206#       发表于 2024-10-4 16:06
 ...
 本帖最后由 Amami_Haruka_ 于 2024-10-5 00:15 编辑 
...
|昵称|战斗力|理由|
|----|---|---|
| hisousihou|-2|一个给钱一个收钱罢了，剩下的都是用户自己.|
